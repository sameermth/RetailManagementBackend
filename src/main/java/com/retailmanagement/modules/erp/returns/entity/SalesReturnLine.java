...
public class SalesReturnLine extends ErpAuditableEntity {
    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    private Long id;
    @Column(name = "sales_return_id", nullable = false)
    private Long salesReturnId;
    @Column(name = "original_sales_invoice_line_id", nullable = false)
    private Long originalSalesInvoiceLineId;
    ...
    @Column(name = "unit_cost_at_return", nullable = false, precision = 18, scale = 2)
    private BigDecimal unitCostAtReturn = BigDecimal.ZERO;
    @Column(name = "total_cost_at_return", nullable = false, precision = 18, scale = 2)
    private BigDecimal totalCostAtReturn = BigDecimal.ZERO;
