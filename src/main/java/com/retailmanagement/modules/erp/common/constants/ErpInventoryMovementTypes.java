package com.retailmanagement.modules.erp.common.constants;

public final class ErpInventoryMovementTypes {
    private ErpInventoryMovementTypes() {}
    ...
    public static final String SERVICE_REPLACEMENT = "SERVICE_REPLACEMENT";
}
