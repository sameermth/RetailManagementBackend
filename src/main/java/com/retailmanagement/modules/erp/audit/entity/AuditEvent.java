...
@Getter @Setter @Entity @Table(name="audit_event", indexes={@Index(name="idx_erp_audit_entity", columnList="entity_type,entity_id"),@Index(name="idx_erp_audit_occurred", columnList="occurred_at")})
public class AuditEvent extends ErpOrgBranchScopedEntity {
 ...
 @Column(name="entity_number") private String entityNumber;
 @Column(nullable=false) private String action;
 @Column(name="actor_user_id", nullable=false) private Long actorUserId;
 @Column(name="actor_name_snapshot") private String actorNameSnapshot;
 @Column(name="actor_role_snapshot") private String actorRoleSnapshot;
