...
public class PurchaseOrderLine extends ErpAuditableEntity {
    ...
    @Column(name = "received_base_quantity", nullable = false, precision = 18, scale = 6)
    private BigDecimal receivedBaseQuantity = BigDecimal.ZERO;
}
